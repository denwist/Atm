...
import readers.ClientFileReader;
import readers.MagneticStripeReader;
import writers.ClientFileWriter;
...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Client> clients = clientFileReader.read(clientsFile);
        ...
        if (clients.size() == 0) {
            ...
            ClientFileWriter clientFileWriter = new ClientFileWriter();
            clientFileWriter.write(new ArrayList<>(clients), clientsFile);
